        ...
        <div id="login"><!-- 登录注册切换动画 -->
            ...
            <span>
                    <form action="${pageContext.request.contextPath}/login" id="login-form" method="post">
                        <p class="form"><input type="text" id="user" placeholder="username" name="username"></p>
                        <p class="form"><input type="password" id="passwd" placeholder="password" name="password"></p>
                        <%--<p class="form confirm"><input type="password" id="confirm-passwd"--%>
                                                       <%--placeholder="confirm password"></p>--%>
                        <input type="submit" value="Log in" class="btn"  style="margin-right: 20px;">
